    ...
    Data Tabel Matakuliah 
      ...
      <div class="card-body">
        <div class="table-responsive">
          ...
          <a class="btn btn-primary btn-block col-md-1" href="import/form_import.php" style="font-size: 14px;float: right;margin-bottom: 20px;"><i class="fa fa-upload"></i> Import</a>
        ...
        include('../config/koneksi.php');
          ...
          $sql = "SELECT * FROM tb_jurusan,tb_matkul WHERE 
            tb_jurusan.kd_jurusan=tb_matkul.kd_jurusan 
            AND tb_matkul.kd_jurusan='$kd_jurusan' ORDER BY id_matkul DESC";

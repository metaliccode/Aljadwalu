...
//jum matkul
$sql2="SELECT count(id_matkul) as jummk from tb_matkul WHERE kd_jurusan='$kd_jurusan' ";
$jummk=mysqli_query($koneksi,$sql2);
$r2=mysqli_fetch_assoc($jummk);
//jum matkul
$sql3="SELECT count(id_jadwal) as jumjad from tb_jadwal WHERE kd_jurusan='$kd_jurusan'";

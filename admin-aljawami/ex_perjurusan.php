...
<div class="card mb-3">
  ...
  <div class="card-header">Hasil Pencarian Jadwal Berdasarkan (Jur/smt/hari) : <?php echo $_POST['jurusan']; ?> / <?php echo $_POST['semester']; ?> / <?php echo $_POST['hari']; ?> 
      <a class="btn btn-danger btn-block col-md-3" href="index_user.php?page=export_data" style="font-size: 14px;float: right;margin-bottom: 0px;"><i class="fa fa-table"></i> View All Data to Export</a>
  </div>
    <div class="card-body">

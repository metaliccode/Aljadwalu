          ...
          if(mysqli_num_rows($query)==0){  
            ...
            while ($data =mysqli_fetch_assoc($query)){ ?>
              <tr>
                ...
                <td><?php 
                  echo " <a href='#edit_modal' class='btn btn-danger fa fa-pencil' data-toggle='modal' data-placement='bottom' title='Edit' data-id=".$data['id_kelas']."></a>";
                  echo ' <a class="btn btn-warning fa fa-trash" data-toggle="tooltip" data-placement="bottom" title="Hapus" href="php/kelas/hapus_kelas.php?id='.$data['id_kelas'].'" onclick="return confirm(\'Apakah Anda Yakin Ingin Mengahapus Data ini?\')"></a> ';
                    ?>
                </td>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header breadcrumb">
                    <h5><i class="fa fa-table"> Form Edit Data Kelas Mahasiswa</i></h5>
                ...
                <table class="table table-bordered table-hover table-striped">
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <input class="form-control" name="kd_kelas" type="text" placeholder="Enter Kode Kelas" required>
                      </td>
                    </tr>
                    
                    <tr>
                      <td>Kelas</td>
                      <td><input class="form-control" name="kelas" type="text" placeholder="Enter Nama Kelas" required ></td>
                    </tr>

...
<div class="card mb-3">
  ...
  <div class="card-header"><i class="fa fa-table"></i> 
    ...
    <a class="btn btn-danger btn-block col-md-3" href="index_user.php?page=dt_jadwal" style="font-size: 14px;float: right;margin-bottom: 0px;"><i class="fa fa-table"></i> View All Data</a>
  </div>
      <div class="card-body">

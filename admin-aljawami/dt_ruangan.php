          ...
          if(mysqli_num_rows($query)==0){  
            ...
            while ($data =mysqli_fetch_assoc($query)){ ?>
              <tr>
                ...
                <td><?php 
                  echo " <a href='#edit_modal' class='btn btn-danger fa fa-pencil' data-toggle='modal' data-placement='bottom' title='Edit' data-id=".$data['id_ruang']."></a>";
                  echo ' <a class="btn btn-warning fa fa-trash" data-toggle="tooltip" data-placement="bottom" title="Hapus" href="php/ruangan/hapus_ruang.php?id='.$data['id_ruang'].'" onclick="return confirm(\'Apakah Anda Yakin Ingin Mengahapus Data ini?\')"></a> ';
                          ?>
                </td>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header breadcrumb">
                    <h5><i class="fa fa-table"> Form Edit Data Ruangan Kelas</i></h5>
...
<div class="modal fade" id="tambah_data" role="dialog">
  <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header breadcrumb">
          <h5><i class="fa fa-table"> Form Tambah Data Ruangan Kelas</i></h5> 
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
          ...
          <div>
              <form action="php/ruangan/tambah_ruang.php" method="POST">
                ...
                <tr>
                  ...
                  <td>
                    <input class="form-control" name="kd_ruang" type="text" placeholder="Enter Kode Ruangan" required>
                  </td>
                </tr>
                
                <tr>
                  <td>Nama Gedung</td>
                  <td><input class="form-control" name="nama_ruang" type="text" placeholder="Enter Nama Ruangan" required ></td>
                </tr>
                <tr>
                  <td colspan=3>

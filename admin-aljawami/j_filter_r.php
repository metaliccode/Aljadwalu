...
<div class="card mb-3">
  ...
  <div class="card-body">
      <form method="POST" action="<?php echo"?page=j_filter_r";?>" >
  ...
  <div class="card-header"><i class="fa fa-table"></i> 
    ...
    <a class="btn btn-danger btn-block col-md-3" href="index.php?page=dt_jadwal_r" style="font-size: 14px;float: right;margin-bottom: 0px;"><i class="fa fa-table"></i> View All Data</a>
  </div>
      <div class="card-body">
          ...
          if (isset($_POST['cari_jadwal'])) {
            ...
            if ($jurusan&&$semester) {
              $sql = "SELECT * FROM tb_matkul,tb_jadwal,tb_dosen,tb_jurusan 
                          ...
                          AND tb_jadwal.kd_jurusan='$jurusan' AND semester='$semester'  
                  ...
                  if(mysqli_num_rows($query)==0){  
                    ...
                    while ($data =mysqli_fetch_assoc($query)){ ?>
                      <tr>
                        ...
                        <td align="center"><?php 
                          echo ' <a class="btn btn-danger fa fa-pencil" data-toggle="tooltip" data-placement="bottom" title="Hapus" href="index.php?page=f_edit_jadwal_r&id='.$data['id_jadwal'].'" </a> ';
              ...
              $sql = "SELECT * FROM tb_matkul,tb_jadwal,tb_dosen,tb_jurusan 
                          WHERE tb_jurusan.kd_jurusan=tb_jadwal.kd_jurusan AND tb_matkul.kd_matkul=tb_jadwal.kd_matkul AND tb_dosen.id_dosen=tb_jadwal.kd_dosen
                          AND tb_jadwal.semester='$semester'  
                          ORDER BY id_jadwal DESC limit $posisi, $batas";
                  $query = mysqli_query($koneksi,$sql);
                  if(mysqli_num_rows($query)==0){  
                    //jika data kosong, maka akan menampilkan row kosong
              ...
              $sql = "SELECT * FROM tb_matkul,tb_jadwal,tb_dosen,tb_jurusan 
                          WHERE tb_jurusan.kd_jurusan=tb_jadwal.kd_jurusan AND tb_matkul.kd_matkul=tb_jadwal.kd_matkul AND tb_dosen.id_dosen=tb_jadwal.kd_dosen
                          AND tb_jadwal.kd_jurusan='$jurusan'  
                          ORDER BY id_jadwal DESC limit $posisi, $batas";
                  $query = mysqli_query($koneksi,$sql);
                  if(mysqli_num_rows($query)==0){  
                    //jika data kosong, maka akan menampilkan row kosong
          ...
          <div class="col-md-6" align="right">
            <nav>
              <ul class="pagination">
                ...
                <a class='page-link' href='index.php?page=dt_jadwal_r&pg=$link' aria-label='Previous'>
                ...
                $nmr.= "<li class='page-item'><a class='page-link' href='index.php?page=dt_jadwal_r&pg=$i'>$i</a></li>";
                }
                }
                ...
                <a class='page-link' href='index.php?page=dt_jadwal_r&pg=$link'aria-label='Next'>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header breadcrumb">
                    <h5><i class="fa fa-table"> Form Edit Data Jadwal Kuliah</i></h5>
...
<!--Edit SKS-->
    <div class="modal fade" id="set_sks" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header breadcrumb">
                    <h5><i class="fa fa-table"> Edit Lama Waktu Kuliah Per SKS</i></h5>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>                    
                </div>
                <div class="modal-body">
                    <div class="hasil-data_sks"></div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Keluar</button>
                </div>
  ...
  <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body" style="font-size: 16px;" >
          <div>
            <form action="php/jadwal/tambah_jadwal_f.php" method="POST" id='form_combo' name='form1'>
            <div class="table-responsive">
            ...
            <tr>
              ...
              <td>
                ...
                */
                ?>
              -->
                <select class="form-control" name='jurusan' onchange='showJurusan()' required>
                  <option value='' selected>-- Pilih Jurusan --</option>
                  <?php
                    $sql = "SELECT * FROM tb_jurusan order by id_jurusan asc";
                    $jurusan = mysqli_query($koneksi,$sql);
    ...
    <!--end triple combo box -->
            ...
            <tr>
              ...
              <td>
                ...
                <!-- 
                <input class="form-control col-md-3" name="lama" type="text" required>
              -->
              </td>
            </tr>
